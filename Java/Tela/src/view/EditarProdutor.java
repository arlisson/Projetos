...
public class EditarProdutor {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EditarProdutor window = new EditarProdutor();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("D:\\Users\\T-GAMER\\eclipse-workspace\\Tela\\img\\seta-esquerda.png"));
		btnNewButton.setBounds(545, 437, 38, 23);
		frame.getContentPane().add(btnNewButton);
		
		JButton btnNewButton_2 = new JButton("Excluir");
		btnNewButton_2.setForeground(new Color(255, 255, 255));
		btnNewButton_2.setBackground(new Color(255, 0, 0));
		btnNewButton_2.setBounds(583, 73, 89, 23);
		frame.getContentPane().add(btnNewButton_2);
		
		JButton btnNewButton_1 = new JButton("");
		btnNewButton_1.setIcon(new ImageIcon("D:\\Users\\T-GAMER\\eclipse-workspace\\Tela\\img\\seta-direita.png"));
		btnNewButton_1.setBackground(new Color(0, 125, 0));
		btnNewButton_1.setBounds(634, 437, 38, 23);
