...
AppId={{93C90FA7-C89C-42C1-B57F-5ABD9EE40718}
AppName={#MyAppName}
...
Source: "C:\Repositorios\Projetos\Python\text_extractor\dist\PreencheFacil\_internal\LICENSE.txt"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Repositorios\Projetos\Python\text_extractor\dist\PreencheFacil\_internal\LICENSE.pt-BR.txt"; DestDir: "{app}"; Flags: ignoreversion
