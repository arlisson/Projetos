...
class EdgeDetectionApp:
    def __init__(self, root):
        ...
        self.filtered_image_multply = None
        self.filtered_image_divide = None
        ...
        # Label para exibir a imagem filtrada com o filtro multply
        self.label_filtered_image_multply = Label(self.root)
        self.label_filtered_image_multply.pack(side='right')

        # Label para exibir a imagem filtrada com o filtro divide
        self.label_filtered_image_divide = Label(self.root)
        self.label_filtered_image_divide.pack(side='right')
    ...
    def apply_multply_filter(self):
        if self.image_rgb1 is not None and self.image_rgb2 is not None:
            ...
            self.filtered_image_multply = result

    def apply_divide_filter(self):
        if self.image_rgb1 is not None and self.image_rgb2 is not None:
    ...
    def apply_all_filters(self):
        # Aplicar todos os filtros
        self.apply_multply_filter()
        self.apply_divide_filter()
