...
<head>
    ...
    <title>Adicionar atestado</title>
    <style type="text/css">
        /* body {
            display: flex;
    ...
    <div class="inside">
        ...
        <form action="Atestado.php" method="POST">
            ...
            <p>
                ...
                <textarea placeholder="Digite a Descrição" name="motivo" maxlength="240" required
            ...
            <p>
                ...
                <textarea placeholder="Digite a Descrição" name="obs" maxlength="240" required
                    style="width: 300px; height: 70px;"></textarea>
            </p>
            <div class="primeiro" , class="segundo">
                <p>
