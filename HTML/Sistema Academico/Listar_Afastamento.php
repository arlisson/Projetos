...
$id = $_GET['id'];
$sql_afast = "SELECT * FROM afastamento WHERE id_pessoa = $id";

$sql = "SELECT * FROM pessoa WHERE id =$id";

//Executa o comando SQL
$sql_query = $conexao->query($sql_afast);
$sql_m = $conexao->query($sql);
$result = mysqli_fetch_assoc($sql_m);

if ($sql_query->num_rows == 0) {
    $_SESSION['msg'] = "<p><h2 class= 'erro'>Essa pessoa não possui afastamento(s)</h2></p>";
}
...
<div class="inside">
    ...
    while ($user_data = mysqli_fetch_assoc($sql_query)) {
        ...
        echo "<td>" . $user_data['data_inicial'] . "</td>";
