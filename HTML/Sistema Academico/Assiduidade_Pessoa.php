...
<head>
    ...
    <title>Adicionar Assiduidade</title>
    <style type="text/css">
        /* body {
            display: flex;
...
<div class="primeiro", class="segundo">
    ...
    ?>
    <form action="Assiduidade.php" method="POST">
        <input type="hidden" value="<?php echo $id ?>" name="id">


        <p>
            <label>Data: </label>
            <input type="date" placeholder="Digite a data inicial" name="data" required>
        </p>

        <input type="hidden" value="1" name="assiduidade">
        </p>
        <div class="primeiro", class="segundo">
        <p>
